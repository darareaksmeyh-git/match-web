<template>
  <div class="container mx-auto p-4">
    ...
    >
      <Slide>
        <div
          class="bg-white border-0 rounded-lg overflow-hidden flex flex-col h-full"
        >
          <a href="#">
            <img
              class="aspect-[4/3] object-cover rounded-t-[20px]"
              src="https://media2.dev.to/dynamic/image/width=1000,height=420,fit=cover,gravity=auto,format=auto/https%3A%2F%2Fdev-to-uploads.s3.amazonaws.com%2Fuploads%2Farticles%2Frxoc4dyke029v8kskwta.png"
              alt="product image"
            />
          </a>
          <div>
            <div
              class="-mt-10 border-2 border-gold relative z-0 bg-blue-100 p-4 rounded-[20px] flex items-center justify-between h-20"
            >
        ...
        >
          ...
          <div>
            <div class="flex-1 flex items-end">
              <div
                class="-mt-10 border-2 border-gold relative z-0 bg-blue-100 p-2 rounded-[20px] flex items-center justify-between w-full h-20"
              >
                <span class="text-3xl font-bold text-gray-900">$599</span>
                <a
                  href="#"
                  class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center gap-2"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="30"
        ...
        >
          <a href="#" class="block relative">
            ...
            <div class="relative">
              ...
              <!-- Circular Hot badge inside image wrapper -->
              <div
                class="absolute -top-4 -right-2 w-16 h-16 bg-red-500 rounded-full flex items-center justify-center shadow-lg overflow-hidden"
              >
                <span class="text-white font-bold">Hot</span>
              </div>
            </div>
          </a>
          <div>
            <div class="flex-1 flex flex-items-end">
              <div
                class="-mt-10 border-2 border-gold relative z-0 bg-blue-100 p-2 rounded-[20px] flex items-center justify-between w-full h-20"
              >
                <span class="text-3xl font-bold text-gray-900">$599</span>
                <a
                  href="#"
                  class="text-white bg-red-500 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center gap-2"
                  >Live</a
                >
              </div>
            </div>
    ...
    <div v-if="showAll" class="grid grid-cols-12 gap-4 mt-4">
      ...
      >
        <div
          class="bg-white border-0 rounded-lg overflow-hidden flex flex-col h-full relative"
        >
          <a href="#">
            <img
              class="aspect-[4/3] object-cover rounded-t-[20px]"
